...
const EditLecturerForms = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      lecturer_id: preloadedUser.lecturer_id,
      department: preloadedUser.department,
  ...
  const mutation = useMutation({
    mutationFn: (userData: any) => {
      ...
      formData.append("lecturer_id", userData.lecturer_id);
          ...
          >
            <section className="flex flex-col w-[50%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow max-md:mt-2 max-md:max-w-full">
                ...
                <div className="flex items-center gap-2 px-16 py-5 mt-2 rounded border border-solid bg-zinc-100 border-neutral-400 max-md:px-5 max-md:max-w-full">
                  {preloadedUser.user.profile_photo && (
                    <label htmlFor="photo_profile">
                      <Image
                        src={
                          preloadedUser.user.profile_photo.startsWith("http")
                            ? preloadedUser.user.profile_photo
                            : `${BASE_URL}${preloadedUser.user.profile_photo}`
                        }
                        alt="Profile Photo"
            ...
            <section className="flex flex-col ml-5 w-[50%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow mt-20 text-xs text-black max-md:mt-10 max-sm:mt-1.5">
                <div className="mt-2 text-xs font-bold text-black max-md:max-w-full max-sm:mt-3.5">
                ...
                <button
                  ...
                  className="justify-center items-center px-16 py-3 mt-14 mr-7 ml-6 text-sm text-center text-white whitespace-nowrap rounded-lg bg-blue-950 max-md:px-5 max-md:mx-2.5 max-md:mt-10"
                >
                  simpan
                </button>
...
export default EditLecturerForms;
