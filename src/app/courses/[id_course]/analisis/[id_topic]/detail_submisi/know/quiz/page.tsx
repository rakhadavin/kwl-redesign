...
const DetailSubmissionKnowQuizPage = () => {
    ...
    return (        
      ...
      <>
        <Breadcrumb items={[{ label: "Beranda", href: "/courses" }, { label: quiz_data?.course_short_name ?? "...", href: `/courses/${params.id_course}` }, { label: "Analisis", href: `/courses/${params.id_course}/analisis` }, { label: quiz_data?.topic ?? "...", href: `/courses/${params.id_course}/analisis/${id_topic}` }, { label: "Know" }, { label: "Quiz" }]} variant="light" />
